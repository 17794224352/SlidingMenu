package takeout.administrator.example.com.slidingmenu;
...
public class SlidingMenu3DSuper extends FrameLayout {
    public SlidingMenu3DSuper(Context context) {
        this(context, null);
    }

    public SlidingMenu3DSuper(Context context, AttributeSet attrs) {
    ...
    int maxLeft;//最大的左边
    public SlidingMenu3DSuper(Context context, AttributeSet attrs, int defStyle) {
...
//                scroller.startScroll();
                ...
                ViewCompat.postInvalidateOnAnimation(SlidingMenu3DSuper.this);
            }else {
                //close
